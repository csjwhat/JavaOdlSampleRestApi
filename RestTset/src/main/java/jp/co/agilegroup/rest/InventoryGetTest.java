...
public class InventoryGetTest {
	...
	public static void main(String[] args) {
		...
		String uri = "http://localhost:8181/restconf/operational/opendaylight-inventory:nodes/node/openflow:1/";

		// 1つのNoddeの情報
		String uri2 = "http://localhost:8181/restconf/operational/opendaylight-inventory:nodes/node/openflow:1/node-connector/openflow:1:3/";
